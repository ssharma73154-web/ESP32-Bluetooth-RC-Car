...
A Bluetooth-controlled RC car project powered by an Arduino microcontroller. This project features wireless mobile control and custom police-style alternating strobe lights using non-blocking delays (millis).
...
## 💻 The Code
The complete Arduino code for this project is available in this repository. 
👉 [Click here to view the RC_Car_Code.ino file](RC_Car_Code.ino)

## ⚙️ How to use
1. Upload the `.ino` file to the Arduino using the Arduino IDE. (Note: Disconnect the HC-05 TX/RX pins while uploading code).
